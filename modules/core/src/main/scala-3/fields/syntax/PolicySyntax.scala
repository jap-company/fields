...
trait PolicySyntax {
  extension [P, F[_], V[_], E](builder: ValidationPolicyBuilder[P, F, V, E]) {
    ...
    inline def subRule[S](
        inline selector: P => S
    )(rules: Field[S] => Rule[F, V, E]*): ValidationPolicyBuilder[P, F, V, E] =
    ...
    )(rules: Tuple2[Field[S1], Field[S2]] => Rule[F, V, E]*): ValidationPolicyBuilder[P, F, V, E] =
    ...
    )(rules: Tuple3[Field[S1], Field[S2], Field[S3]] => Rule[F, V, E]*): ValidationPolicyBuilder[P, F, V, E] =
