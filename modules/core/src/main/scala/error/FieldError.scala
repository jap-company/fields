...
object FieldError {
  def failWith[E, P](implicit failWithError: FailWith[E, P]): FailWith[FieldError[E], P] =
    FailWith.Mapped(FieldError(_, _: E))

  implicit val failWithFieldErrorMessage: FailWith.Base[FieldError[String]] = failWith(FailWith.string.errorMessage)
}
