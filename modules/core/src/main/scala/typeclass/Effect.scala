...
/** [[fields.typeclass.Effect]] is a typeclass that provides ValidationDsl with Monad/Defer capabilities. */
trait Effect[F[_]] {
...
object Effect {
  ...
  /** Sync [[fields.typeclass.Effect]]. Short-circuit wont work with it. */
  type Sync[A] = A
  ...
  object future {
    ...
    /** Future [[fields.typeclass.Effect]]. Sadly Future is not lazy so short-circuit wont work with it, too.
      */
